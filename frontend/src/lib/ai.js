...
import { extractAndRepairJson, validateAndMergeBrief, createFallbackBrief, getMaxTokensForMode, formatTabValue } from './jsonRepair.js';
...
export const generateTabContent = async (idea, mode, tabName, previousTabs = {}, metadata = {}) => {
  ...
  try {
    ...
    const tabContent = formatTabValue(extracted.tabs?.[tabName] || '', tabName);
