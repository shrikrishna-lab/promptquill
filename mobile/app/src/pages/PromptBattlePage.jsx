      ...
      {!session?.user ? (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <h1 style={{ fontSize: '28px', fontWeight: '800', marginBottom: '12px' }}>Prompt Battle</h1>
            <p style={{ color: '#888', fontSize: '14px', marginBottom: '32px', maxWidth: '300px', margin: '0 auto 32px' }}>
              Sign in to vote on the best AI prompts and see which creative ideas win.
            </p>
